 ...
 * 
 * This function advances the index to the next occurrence of a specified quote character in the string,
 * updating a flag to indicate whether the quote is closed or not.
 * 
 * @param line The input string.
 * @param flag Pointer to an integer flag indicating the status of the quote (closed or not).
 ...
 * 
 * @see check_unclosed_quotes() function for checking if quotes are properly closed.
 * 
 ...
 * 
 * This function checks whether single and double quotes in the given string are properly closed.
 * 
...
/**
 * @brief Checks if a token character is valid at a specified position within a string.
 * 
 * This function checks if the token character at the specified position is valid,
 ...
 * 
 * @return Returns 0 if the token is not valid at the specified position, otherwise returns 1.
 * 
 * @warning This function assumes that the input string is null-terminated.
 */
 ...
 * 
 * @note This function allocates memory for the new word. The caller is responsible for freeing this memory.
 * 
 * @warning This function assumes that the input string is null-terminated.
 */
 ...
 * adds the modified substring to a word, and frees the memory of the modified substring.
 * 
